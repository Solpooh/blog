                    ...
                    <div className='auth-card-bottom'>
                        ...
                        <>
                            <div className='auth-content-box'>
                                ...
                                <div className='auth-content-title'>{'개인정보 동의'}</div>
                                <div className='auth-content-link'>{'더보기 >'}</div>
                            </div>
                            <div className='black-large-full-button' onClick={onNextButtonClickHandler}></div>
                        </>
                        )}
                        <div className='auth-description-box'>
